...
class Watchdog(WatchdogBase):
    ...
    def _enable(self):
        ...
        """
        # echo 0xA182 0x1 > /sys/devices/platform/sys_cpld/setreg
    ...
    def _disable(self):
        ...
        """
        # echo 0xA182 0x0 > /sys/devices/platform/sys_cpld/setreg
    ...
    def _keepalive(self):
        ...
        """
        # echo 0xA183 0x1 > /sys/devices/platform/sys_cpld/setreg
        # echo 0xA183 0x0 > /sys/devices/platform/sys_cpld/setreg
        enable_val = '{} {}'.format(WDT_KEEP_ALVIVE_REG, ENABLE_CMD)
        enable_val = '{} {}'.format(WDT_KEEP_ALVIVE_REG, DISABLE_CMD)
        return self._api_helper.write_txt_file(self.setreg_path, enable_val)
    ...
    def _settimeout(self, level):
        """
        Set watchdog timer timeout
        @param seconds - timeout level: 0-200ms 1-30s 2-1min 3-3min 4-4min 5-5min 6-7min 7-10min
        @return is the actual set timeout
        """
        set_val = '{} 0x{}'.format(WDT_TIMER_REG, level)
        self._api_helper.write_txt_file(self.setreg_path, set_val)
        return level
    ...
    def arm(self, seconds):
        ...
        try:
            # 7 is the max level of time value
            seconds = 7 if seconds > 7 else seconds
