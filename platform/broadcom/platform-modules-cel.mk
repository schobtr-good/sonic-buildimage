...
CEL_BLACKSTONE_PLATFORM_MODULE_VERSION = 0.9
...
export CEL_BLACKSTONE_PLATFORM_MODULE_VERSION
...
CEL_BLACKSTONE_PLATFORM_MODULE = platform-modules-blackstone_$(CEL_BLACKSTONE_PLATFORM_MODULE_VERSION)_amd64.deb
$(CEL_BLACKSTONE_PLATFORM_MODULE)_PLATFORM = x86_64-cel_blackstone-r0
$(eval $(call add_extra_package,$(CEL_DX010_PLATFORM_MODULE),$(CEL_BLACKSTONE_PLATFORM_MODULE)))
