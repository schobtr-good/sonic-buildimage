...
CEL_JAWS_PLATFORM_MODULE_VERSION = 0.9
CEL_MIGALOO_PLATFORM_MODULE_VERSION = 0.9
...
export CEL_JAWS_PLATFORM_MODULE_VERSION
...
CEL_JAWS_PLATFORM_MODULE = platform-modules-jaws_$(CEL_JAWS_PLATFORM_MODULE_VERSION)_amd64.deb
$(CEL_JAWS_PLATFORM_MODULE)_PLATFORM = x86_64-alibaba_as14-128h-cl-r0
$(eval $(call add_extra_package,$(CEL_DX010_PLATFORM_MODULE),$(CEL_JAWS_PLATFORM_MODULE)))

CEL_MIGALOO_PLATFORM_MODULE = platform-modules-migaloo_$(CEL_MIGALOO_PLATFORM_MODULE_VERSION)_amd64.deb
$(CEL_MIGALOO_PLATFORM_MODULE)_PLATFORM = x86_64-alibaba_as24-128d-cl-r0
$(eval $(call add_extra_package,$(CEL_DX010_PLATFORM_MODULE),$(CEL_MIGALOO_PLATFORM_MODULE)))
