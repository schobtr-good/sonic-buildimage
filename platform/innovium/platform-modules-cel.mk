...
CEL_PLATFORM_MODULE_VERSION = 0.2.3
CEL_MRVL_CPO1_MODULE_VERSION = 0.2.3

export CEL_PLATFORM_MODULE_VERSION
export CEL_MRVL_CPO1_MODULE_VERSION
...
CEL_MRVL_CPO1_PLATFORM_MODULE = platform-modules-mrvl-cpo1_$(CEL_MRVL_CPO1_MODULE_VERSION)_$(CONFIGURED_ARCH).deb
$(CEL_MRVL_CPO1_PLATFORM_MODULE)_PLATFORM = x86_64-cel_marvell_tl7-r0
$(eval $(call add_extra_package,$(CEL_MIDSTONE_200I_PLATFORM_MODULE),$(CEL_MRVL_CPO1_PLATFORM_MODULE)))
